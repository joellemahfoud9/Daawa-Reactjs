  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center mt-10 pt-12 bg-gray-100 w-full">
      ...
      <div
        ...
        style={{ backgroundImage: "url(src/assets/Testimonial/1_R61828.jpg)" }}
      >
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center px-8 text-white space-y-2">
          ...
          <p className="mt-2 max-w-xs">
            ...
            Here you can find some of our affectionate customers opinions.
          </p>
        </div>
      </div>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8">
        <div className="bg-white p-6 rounded-lg shadow-lg max-w-lg">
          <p className="text-gray-700 italic mb-4">
            &quot;I had no idea about all the things I had to do to get married
            / things I needed to think about. Rachel explained everything to me
            and guided me through the whole process with enthusiasm and
            patience. She was wonderful to work with! I couldn&apst;t have been
            happier with her services and upbeat personality!&quot;
          </p>
          <div className="flex items-center mt-4">
            <img
              src="src/assets/Testimonial/1_R61828.jpg"
              alt="Client"
