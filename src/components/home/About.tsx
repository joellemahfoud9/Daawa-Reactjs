      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-primary">Consult</h3>
            <p className="text-primary">
              Write about your process here! Lorem ipsum dolor sit amet,
          ...
          {/* Wedding Day Section */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-primary">Wedding Day</h3>
            <p className="text-primary">
              Write about your process here! Lorem ipsum dolor sit amet,
              consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
              labore et. Lorem ipsum dolor sit amet, consectetur adipiscing
