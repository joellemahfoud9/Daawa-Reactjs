...
const ShoppingCart = () => {
  ...
  useEffect(() => {
    const total = cartItems.reduce((acc, item) => acc + (item.price * item.quantity), 0) + shipping - discount;
  ...
  return (
    <div className=" min-h-screen flex justify-center items-center">
      <div className="w-full max-w-2xl p-6 bg-white shadow-lg">
        ...
        {/* Checkout Button */}
        <button className="w-full bg-black text-white py-3 mt-6 font-semibold rounded">Proceed To Checkout</button>
