  ...
  const filteredServices = servicesData
    .filter(service => 
      ...
      (service.serviceName.toLowerCase().includes(searchTerm.toLowerCase()) || 
       service.companies.some(company => company.name.toLowerCase().includes(searchTerm.toLowerCase())))
    );

  return (
    <div className="max-w-7xl mx-auto p-6 bg-gray-50 min-h-screen">
      <Navbar/>
      <div className="mb-8 mt-20 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              {service.companies.map(company => (
                ...
                >
                  ...
                  <div className="absolute bottom-4 left-4 right-4 p-4 bg-black bg-opacity-50 rounded-lg">
                    {/* Star Rating */}
